...
def parsethepage(res):
    ...
    table1=tables[1]
    table2=tables[2]
    rows2=Table2Parse(table2)#list of lists of row-wise details with the last element in each row being the href link
    rows1=Table1Parse(table1)#dictionary with key as the description and value as the download link/function
    return rows1,rows2
